...
private
theorem toDigitsCore_head_nonzero
    : ∀ (fuel n : Nat) (_hn : 0 < n),
      0 < fuel →
      n < 10 ^ fuel →
      ∃ c rest,
...
theorem isDigit19_of_toNat_bounds
    (b : UInt8)
    (h49 : 49 ≤ b.toNat)
    (h57 : b.toNat ≤ 57)
...
theorem isDigit_of_toNat_bounds
    (b : UInt8)
    (h48 : 48 ≤ b.toNat)
    (h57 : b.toNat ≤ 57)
